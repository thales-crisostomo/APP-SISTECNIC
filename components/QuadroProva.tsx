...
const url = "http://dmctec.virtuaserver.com.br/logup-dat/ws/dadoslogup-quadroavaliacao.php?acao=quadrodeavaliacao&idturma="

export default function QuadroProva(props) {
  ...
  return (
    <>
        ...
        <SafeAreaView style={{display: 'flex', flex: 1, backgroundColor: 'white'}}>
            <Header name={'Quadro de prova'} icon1={<FontAwesome name="long-arrow-left" size={24} color="white" />} icon2={''} colorText={'white'} color='#00B0FF' onPress1={() => navigation.goBack()} />
